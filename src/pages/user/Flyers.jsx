...
{/* Navigation Below the Hero */}
      ...
      <section style={{ maxWidth: "1200px", margin: "50px auto", padding: "0 20px" }}>
        <h2 style={{ fontSize: "24px", marginBottom: "20px", textAlign: "center" }}>Shop Flyers & Leaflets by Size</h2>
        <div style={{ 
  display: "flex", 
  justifyContent: "center", 
  flexWrap: "wrap", 
        ...
        <div style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: "20px" }}>
          {[
            ...
            <div key={idx} style={{ width: "200px", textAlign: "center" }}>
              <img src={`/assets/flyers/${tpl.img}`} alt={tpl.title} style={{ width: "100%", borderRadius: "8px" }} />
